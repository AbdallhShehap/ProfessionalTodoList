...
export default function TodoList() {
	...
	console.log("++++++++++++++++++++++++")
console.log("the state and the dispatch fron the todoList componnet : ", currentTodos)
	...
	let todosToBeRendered = currentTodos;
	...
	if (displayedTodosType == "completed") {
		...
		todosToBeRendered = currentTodos;
	}
	...
	function handleAddClick() {
		...
		dispatch({type:"add", payload:{newTitle2:titleInput}})
	...
	function handleDeleteConfirm(todo) {
